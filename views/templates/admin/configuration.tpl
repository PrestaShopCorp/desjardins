...
<div class="desjardins">
	...
	<div class="desjardins-content">
		<div class="desjardins-leftCol">
			<h3 style="margin: 0;">{l s='DOING E-BUSINESS WITH DESJARDINS MEANS:' mod='desjardins'}</h3>
			<ul>
		...
		<div class="desjardins-video">
			...
			<a href="https://www.youtube.com/watch?v=HFRWRlKiVxY" class="desjardins-video-btn"><img src="{$module_dir|escape:html:'UTF-8'}img/video-screen.jpg" alt="Desjardins screencast" /><img src="{$module_dir|escape:html:'UTF-8'}img/btn-video.png" alt="" class="video-icon" /></a>
